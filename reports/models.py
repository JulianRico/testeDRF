...
class Report(models.Model):
    ...
    user = models.ForeignKey(User, related_name='reports', on_delete=models.CASCADE, blank=True, null=True)
    companie = models.ForeignKey(Companie,related_name='reports', on_delete=models.CASCADE, blank=True, null=True)    
